  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'font',
            { style: _input2.default.isRequired(rules) },
            '*'
          ),
          title
        ),
    ...
    value: function validator() {
      ...
      return function (e) {
        ...
        func({ value: e.target.value, isError: isError, e: e });

        _this2.setState({ isError: isError, uploadInfo: uploadInfo, message: message });
      };
    }
  }]);
